...
const translations = {
  cs: {
    ...
    userManagement: 'Uživatelé',
    noUsers: 'Žádní uživatelé',
    roleAdmin: 'Admin',
    roleMember: 'Člen',
    createUserHint: 'Nové uživatele vytvořte v Supabase Dashboard (Authentication > Users)',
  ...
  en: {
    ...
    roleAdmin: 'Admin',
    roleMember: 'Member',
    createUserHint: 'Create new users in Supabase Dashboard (Authentication > Users)',
